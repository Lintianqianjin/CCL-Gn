...
class Net(torch.nn.Module):
    def __init__(self, config):
        ...
        self.convs.append(GCNConv(in_channels=self.in_dim, out_channels=self.hid_dim))
        self.bns.append(torch.nn.BatchNorm1d(self.hid_dim))

        for _ in range(self.num_layers - 2):
            self.convs.append(GCNConv(in_channels=self.hid_dim, out_channels=self.hid_dim))
            self.bns.append(torch.nn.BatchNorm1d(self.hid_dim))
